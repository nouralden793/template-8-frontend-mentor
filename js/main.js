...
let filterHead = document.querySelector(".filter-place .filter-head");
let optionsCont = document.querySelector(".filter-place .options");

let mainContainer = document.querySelector(".content .container");
let searchInput = document.querySelector(".search-input input");
let flagDetailsCont = document.querySelector(".flag-detal");
let optionsP = document.querySelectorAll(".options p");
let detalImgCont = document.querySelector(".flag-content .flag");
let detalHead = document.querySelector(".flag-content .cont .head");
let flagDetails = document.querySelector(".flag-content .flag-details");
let countries = document.querySelector(".countries");
let boxs;
setTimeout(() => {
  boxs = document.querySelectorAll(".content .container .box");
}, 1000);
let there = "";

filterHead.addEventListener("click", (e) => {
  optionsCont.classList.toggle("scale-y-0");
  mainContainer.classList.toggle("padding-top");
});
...
function addBoxsToPage(data) {
  data.forEach((obj) => {
    ...
    theBox.className = `box ${obj.region.toLowerCase()} ${obj.name} all`;
    theBox.dataset.name = `${obj.name}`;
    theBox.dataset.link = `.${obj.name}`;
    let flagDiv = document.createElement("div");
    flagDiv.className = "flag";
    let flagImg = document.createElement("img");
    flagImg.alt = "You'r Internet Is Bad";
    ...
    popSpan.textContent = obj.population;
    pop.appendChild(popSpan);
    let reg = document.createElement("p");
    reg.textContent = "Region:";
    let regSpan = document.createElement("span");
    regSpan.textContent = obj.region;
    reg.appendChild(regSpan);
    let cap = document.createElement("p");
    cap.textContent = "Capital:";
    let capSpan = document.createElement("span");
    capSpan.textContent = obj.capital;
    cap.appendChild(capSpan);
    detal.appendChild(pop);
    detal.appendChild(reg);
    detal.appendChild(cap);
    flagDiv.appendChild(flagImg);
    theBox.appendChild(flagDiv);
    theBox.appendChild(h1);
    theBox.appendChild(detal);
    mainContainer.appendChild(theBox);
    flagDiv.addEventListener("click", (e) => {
      turn(obj);
    });
  });
}
...
setTimeout(() => {
  document.querySelectorAll(".box").forEach((box) => {
    if (box.dataset.name == "Israel") {
      box.remove();
    }
    if (box.dataset.name == "Nepal") {
      box.remove();
    }
  });
}, 100);
...
optionsP.forEach((p) => {
  p.addEventListener("click", (e) => {
    ...
    setTimeout(() => {
      document.querySelectorAll(e.target.dataset.region).forEach((div) => {
        div.classList.remove("none");
      });
    }, 100);
    optionsCont.classList.add("scale-y-0");
  });
});

function turn(obj) {
  optionsCont.classList.add("scale-y-0");
  detalImgCont.textContent = "";
  flagDetails.textContent = "";
  detalHead.textContent = "";
  let detalImg = document.createElement("img");
  detalImg.alt = "You'r Internet Is Bad";
  detalImg.src = obj.flags.png;
  detalImgCont.appendChild(detalImg);
  let firstDiv = document.createElement("div");
  let firstP = document.createElement("p");
  let firstSpan = document.createElement("span");
  firstSpan.textContent = obj.name;
  firstP.textContent = `Native Name: `;
  firstP.appendChild(firstSpan);
  let secondP = document.createElement("p");
  let secondSpan = document.createElement("span");
  secondSpan.textContent = obj.population;
  secondP.textContent = `Population: `;
  secondP.appendChild(secondSpan);
  let thirdP = document.createElement("p");
  let thirdSpan = document.createElement("span");
  thirdSpan.textContent = obj.region;
  thirdP.textContent = `Region: `;
  thirdP.appendChild(thirdSpan);
  let fourthP = document.createElement("p");
  let fourthSpan = document.createElement("span");
  fourthSpan.textContent = obj.subregion;
  fourthP.textContent = `Sub Region: `;
  fourthP.appendChild(fourthSpan);
  let fifthP = document.createElement("p");
  let fifthSpan = document.createElement("span");
  fifthSpan.textContent = obj.capital;
  fifthP.textContent = `Capital: `;
  ...
  let firstSecondP = document.createElement("p");
  let firstSecondSpan = document.createElement("span");
  firstSecondSpan.textContent = obj.topLevelDomain;
  firstSecondP.textContent = `Top Level Domain: `;
  firstSecondP.appendChild(firstSecondSpan);
  let secondSecondP = document.createElement("p");
  let secondSecondSpan = document.createElement("span");
  secondSecondSpan.textContent = obj.currencies[0].name;
  secondSecondP.textContent = `Currencies: `;
  secondSecondP.appendChild(secondSecondSpan);
  let thirdSecondP = document.createElement("p");
  let thirdSecondSpan = document.createElement("span");
  if (obj.languages) {
    text = [];
    ...
    realText = text.join(", ");
    thirdSecondSpan.textContent = realText;
  } else {
    thirdSecondSpan.textContent = "The Languages For This Country Is Unknown";
  }
  thirdSecondP.textContent = `Languages: `;
  thirdSecondP.appendChild(thirdSecondSpan);
  secondDiv.appendChild(firstSecondP);
  secondDiv.appendChild(secondSecondP);
  secondDiv.appendChild(thirdSecondP);
  flagDetails.appendChild(firstDiv);
  flagDetails.appendChild(secondDiv);
  if (obj.borders) {
    countries.textContent = "";
    obj.borders.forEach((thign) => {
      const pcountries = document.createElement("p");
      pcountries.textContent = thign;
      countries.append(pcountries);
    });
  } else {
    let p = document.createElement("p");
    p.textContent = "There Is No Borders For This Country";
    countries.appendChild(p);
  }
  flagDetailsCont.classList.remove("hidden");
  detalHead.append(obj.name);
  document
    .querySelector(".project .content .container")
    .classList.add("hidden");
}

document
  .querySelector(".flag-detal .container .back")
  .addEventListener("click", (e) => {
    ...
    flagDetails.textContent = "";
    countries.textContent = "";
    flagDetailsCont.classList.add("hidden");
  });
...
searchInput.addEventListener("input", (e) => {
  ...
  if (boxs) {
    ...
    boxs.forEach((box) => {
      ...
      let splitValue = e.target.value.toLowerCase().split("");
      let rightLetters = 0;
  ...
  setTimeout(() => {
    if (boxs) {
      boxs.forEach((box) => {
        ...
        if (box.dataset.name.toLowerCase() == e.target.value.toLowerCase()) {
          box.style.order = 1;
        }
      });
    }
...
document.querySelector(".mode").addEventListener("click", (e) => {
  ...
  if (document.querySelector(".mode").classList.contains("dark-mode")) {
  ...
  document.querySelector(".mode").appendChild(i);
  document.querySelector(".mode").appendChild(span);
  document.querySelector(".header .container").classList.toggle("text-white");
  document.querySelector(".header").classList.toggle("shadow-special");
  document.querySelector(".header").classList.toggle("background-normal");
  document.body.classList.toggle("body-normal");
  document.querySelector(".search-input").classList.toggle("background-normal");
  document.querySelector(".search-input").classList.toggle("shadow-lg");
  document
    .querySelector(".search-input input")
    .classList.toggle("background-normal");
  document.querySelector(".search-input input").classList.toggle("text-white");
  document
    .querySelector(".filter-place .filter-head")
  ...
  document
    .querySelector(".filter-place .filter-head")
    .classList.toggle("dark-shadow-lg");
  document
    .querySelector(".filter-place .options")
    .classList.toggle("text-white");
  document
    .querySelector(".filter-place .options")
    .classList.toggle("background-normal");
  document
    ...
    .classList.toggle("dark-shadow-lg");
  boxs.forEach((box) => {
    box.classList.toggle("dark-shadow-lg");
    box.classList.toggle("background-normal");
    box.classList.toggle("text-white");
    box.children[0].children[0].classList.toggle("dark-border-body");
  });
  flagDetailsCont.children[0].classList.toggle("dark");
});
